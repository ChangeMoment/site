...
Object.assign(serviceFaqOverrides, {
  ifhp: {
    ...
    fa: [
      ...
      { q: "آیا IFHP مشاوره سلامت روان را پوشش می‌دهد؟", a: "پوشش IFHP می‌تواند شامل خدمات سلامت روان توسط ارائه‌دهندگان رجیسترد در IFHP باشد. پوشش به دسته‌بندی خاص IFHP شما بستگی دارد. از ۱ مه ۲۰۲۶، مشاوره سلامت روانِ واجد شرایط جزو خدمات تکمیلی است و ۳۰٪ سهم پرداختی مراجع دارد. پوشش شما را پیش از جلسه تأیید می‌کنیم." },
