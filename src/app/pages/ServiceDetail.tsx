...
const ifhpCounsellingCopy: Record<"en" | "fr" | "fa", OnlineCopy> = {
  en: {
    ...
    extraBodyPlacement: "beforeHow",
    extraBody: "The Interim Federal Health Program (IFHP) is a Government of Canada program that provides limited, temporary health coverage — including eligible mental health counselling — to eligible refugees, protected persons, refugee claimants, and certain other groups who are not yet covered by a provincial or territorial health insurance plan. Coverage depends on the beneficiary's IFHP category and must be confirmed before care. Since May 1, 2026, eligible mental health counselling is a supplemental benefit with a 30% client co-payment. At ChangeMoment Mental Health Center, our team supports IFHP clients with trauma recovery, anxiety, depression, grief, resettlement stress, cultural adjustment, family challenges, and the many layers of emotional experience that come with starting over.",
  ...
  fr: {
    ...
    extraBodyPlacement: "beforeHow",
    extraBody: "Le Programme fédéral de santé intérimaire (PFSI) est un programme du gouvernement du Canada qui offre une couverture de santé limitée et temporaire — incluant le counselling en santé mentale admissible — aux réfugiés admissibles, aux personnes protégées, aux demandeurs d'asile et à certains autres groupes non encore couverts par un régime provincial. La couverture dépend de la catégorie PFSI du bénéficiaire et doit être confirmée avant les soins. Depuis le 1er mai 2026, le counselling en santé mentale admissible est une prestation complémentaire avec une quote-part de 30 % à la charge du client. Chez ChangeMoment Mental Health Center, notre équipe soutient les clients PFSI face au trauma, à l'anxiété, à la dépression, au deuil, au stress de réinstallation, à l'adaptation culturelle et aux défis familiaux.",
  ...
  fa: {
    ...
    heroIntro: "پس از این سفر شجاعانه، شما شایسته یک زندگی تازه هستید.",
    introTitle: "مشاوره IFHP در مرکز سلامت روان ChangeMoment",
    introBody: "در مرکز سلامت روان ChangeMoment، ما برای افرادی که تحت پوشش برنامه موقت فدرال سلامت (IFHP) هستند خدمات مشاوره ارائه می‌دهیم — برنامه‌ای دولتی کانادا که پوشش موقت و محدود به پناهندگان واجد شرایط، افراد تحت حمایت، متقاضیان پناهندگی و برخی گروه‌های دیگر که هنوز تحت پوشش بیمه سلامت استانی نیستند ارائه می‌کند. مشاوران رجیسترد ما در کوکیتلام، بریتیش کلمبیا مشاوره حضوری IFHP و در سراسر بریتیش کلمبیا مشاوره آنلاین ارائه می‌دهند؛ با رویکردی متمرکز بر تروما و حساس به فرهنگ که اثر عاطفی مهاجرت و شروع دوباره در کشوری تازه را با احترام و مورد تأمل قرار می‌دهد. می‌دانیم مسیر رسیدن به اینجا ممکن است طولانی و سخت بوده باشد؛ ما با صبر و همدلی در کنار شما هستیم.",
    ...
    whoItems: [
      ...
      { title: "متقاضیان پناهندگی", body: "افرادی که در انتظار تصمیم درباره درخواست پناهندگی خود هستند و اغلب با ابهام، ترس و فشار روانی سنگینی زندگی می‌کنند." },
      { title: "بازماندگان تروما یا خشونت", body: "کسانی که جنگ، آزار، جابه‌جایی، فقدان یا خشونت را تجربه کرده‌اند و هنوز اثر روحی و روانی آن تجربه‌ها را با خود دارند." },
      { title: "افرادی که با موانع فرهنگی و زبانی روبه‌رو هستند", body: "تازه‌واردانی که در زبان، فرهنگ و سیستم تازه‌ای دست‌وپنجه نرم می‌کنند و احساس انزوا یا فاصله از منابع حمایتی دارند." },
      { title: "خانواده‌ها و افراد در دوران گذار", body: "کسانی که سوگ آنچه پشت سر گذاشتند را تجربه می‌کنند و در عین حال تلاش می‌کنند در مکانی ناآشنا امید و ثبات بسازند." },
    ],
    extraListTitle: "چگونه به مشاوره IFHP دسترسی داشته باشم؟",
    extraListIntro: "اگر تحت پوشش این برنامه هستید، دسترسی به مشاوره می‌تواند با چند قدم ساده شروع شود.",
    extraListItems: [
    ...
    extraBodyTitle: "برنامه IFHP چیست؟",
    extraBodyPlacement: "beforeHow",
    extraBody: "برنامه موقت فدرال سلامت (IFHP) برنامه‌ای از دولت کانادا است که پوشش محدود و موقتی — از جمله مشاوره سلامت روان — به پناهندگان واجد شرایط، افراد تحت حمایت، متقاضیان پناهندگی و برخی گروه‌های دیگری که هنوز تحت پوشش برنامه بیمه سلامت استانی نیستند ارائه می‌دهد. پوشش IFHP می‌تواند شامل خدمات مشاوره توسط مشاوران رجیسترد باشد. در مرکز سلامت روان ChangeMoment، تیم ما آماده کمک به مراجعان IFHP در بهبود تروما، اضطراب، افسردگی، سوگ، استرس اسکان مجدد، سازگاری فرهنگی، چالش‌های خانوادگی و لایه‌های مختلف تجربه عاطفی ناشی از شروع دوباره است. از ۱ مه ۲۰۲۶، برای مشاوره سلامت روانِ واجد شرایط که جزو خدمات تکمیلی IFHP است، ۳۰٪ سهم پرداختی مراجع اعمال می‌شود و پوشش باید پیش از جلسه تأیید شود.",
    howTitle: "مشاوره IFHP چگونه می‌تواند به شما کمک کند؟",
    howItems: [
      { title: "ایجاد امنیت و ثبات در وهله اول", body: "ابتدا به شما کمک می‌کنیم احساس ثبات، شنیده شدن و امنیت روانی داشته باشید — به‌ویژه اگر سیستم عصبی شما مدت طولانی تحت فشار بوده است." },
      { title: "پردازش تروما و فقدان با ریتم مناسب شما", body: "با هم سنگینی عاطفی سفر شما — مهاجرت، فقدان، ابهام و سوگ — را با ریتم مناسب شما بررسی می‌کنیم." },
      { title: "ساختن ریشه و تاب‌آوری", body: "در بازسازی حس تعلق، تقویت پیوندهایتان و پرورش منابع درونی که برای زندگی در خانه جدیدتان نیاز دارید، کنارتان هستیم." },
    ],
    progressTitle: "پیشرفت در فرایند درمان IFHP چگونه است؟",
    progressBody: "پیشرفت در مشاوره IFHP اغلب با احساس تنهایی کمتر شروع می‌شود — حسی که کسی واقعاً داستان شما را بدون قضاوت شنیده. به تدریج کمتر در حالت آماده‌باش هستید و کلماتی برای بیان تجربه‌تان دارید. با گذشت زمان، مشاوره می‌تواند به کاهش فشار تروما، کاهش اضطراب و غم، تقویت حس هویت و تعلق و ساختن اعتمادبه‌نفس در مسیر اسکان در کانادا کمک کند.",
...
Object.assign(serviceFaqOverrides, {
  ifhp: {
    en: [
      ...
      { q: "Does IFHP cover mental health counselling?", a: "IFHP coverage can include eligible mental health services from an IFHP-registered provider. Coverage depends on your specific IFHP category and benefits. Since May 1, 2026, eligible counselling is a supplemental benefit with a 30% client co-payment. We confirm eligibility and coverage before care." },
      ...
      { q: "What languages are sessions available in?", a: "We offer counselling in English, and Farsi (Persian). Language access is important to us, and we strive to match you with a counsellor who can support you in your preferred language or with the cultural knowledge that matters to your experience." },
    ...
    fr: [
      { q: "Qu'est-ce que le Programme fédéral de santé intérimaire (PFSI)?", a: "Le Programme fédéral de santé intérimaire (PFSI) est un programme du gouvernement du Canada qui offre une couverture de santé limitée et temporaire — incluant le counselling en santé mentale admissible — aux réfugiés admissibles, aux personnes protégées, aux demandeurs d'asile et à certains autres groupes non couverts par un régime provincial. Depuis le 1er mai 2026, le counselling admissible est une prestation complémentaire avec une quote-part de 30 %." },
      ...
      { q: "Le PFSI couvre-t-il le counselling en santé mentale?", a: "La couverture PFSI peut inclure des services de santé mentale admissibles fournis par un prestataire inscrit au PFSI. Elle dépend de votre catégorie et de vos prestations. Depuis le 1er mai 2026, le counselling admissible est une prestation complémentaire avec une quote-part de 30 %. Nous confirmons l'admissibilité et la couverture avant les soins." },
      ...
      { q: "Dans quelles langues les séances sont-elles disponibles?", a: "Nous offrons le counselling en anglais et en persan (farsi). L'accès linguistique est important pour nous et nous nous efforçons de vous jumeler avec un conseiller qui peut vous soutenir dans votre langue préférée ou avec la sensibilité culturelle pertinente à votre vécu." },
    ...
    fa: [
      { q: "برنامه موقت فدرال سلامت (IFHP) چیست؟", a: "برنامه موقت فدرال سلامت (IFHP) برنامه‌ای دولتی در کانادا است که پوشش محدود و موقت — از جمله مشاوره سلامت روان — به پناهندگان واجد شرایط، افراد تحت حمایت، متقاضیان پناهندگی و برخی گروه‌های دیگری که هنوز تحت پوشش بیمه سلامت استانی نیستند ارائه می‌دهد. از ۱ مه ۲۰۲۶، مشاوره سلامت روانِ واجد شرایط جزو خدمات تکمیلی است و ۳۰٪ سهم پرداختی مراجع دارد." },
      { q: "چه کسانی واجد شرایط مشاوره IFHP هستند؟", a: "شرایط پذیرش توسط دولت کانادا تعیین شده. اگر پناهنده اسکان‌یافته، شخص تحت حمایت، متقاضی پناهندگی یا عضوی از گروه‌های واجد شرایط IFHP هستید، ممکن است بتوانید از این برنامه استفاده کنید. اگر دارای پوشش معتبر IFHP هستید که شامل خدمات سلامت روان است، ما می‌توانیم به شما کمک کنیم." },
      { q: "آیا IFHP مشاوره سلامت روان را پوشش می‌دهد؟", a: "پوشش IFHP می‌تواند شامل خدمات سلامت روان توسط ارائه‌دهندگان رجیسترد در IFHP باشد. پوشش به دسته‌بندی خاص IFHP شما بستگی دارد. توصیه می‌کنیم قبل از رزرو وقت، جزئیات پوشش خود را با IFHP چک کنید. از ۱ مه ۲۰۲۶، مشاوره سلامت روانِ واجد شرایط جزو خدمات تکمیلی است و ۳۰٪ سهم پرداختی مراجع دارد." },
      { q: "آیا رویکرد مشاوره شما مبتنی بر تروما است؟", a: "بله. مشاوره ما بر پایه رویکرد متمرکز بر تروما و حساس به فرهنگ است که تجربه شما را با صبر و احترام می‌پذیرد — در هر جایی از مسیر رشد فردی قرار داشته باشید." },
      { q: "آیا می‌توانم مشاوره IFHP را به صورت آنلاین دریافت کنم؟", a: "بله. ما مشاوره حضوری در کوکیتلام، بریتیش کلمبیا و مشاوره آنلاین برای ساکنان سایر نقاط بریتیش کلمبیا ارائه می‌دهیم. مشاوره آنلاین در صورتی که رفت‌وآمد، مراقبت از کودک یا مسئولیت‌های دیگر جلسات حضوری را دشوار می‌کند، بسیار مفید است." },
      { q: "جلسات به چه زبان‌هایی ارائه می‌شوند؟", a: "ما مشاوره به زبان‌های انگلیسی و فارسی ارائه می‌دهیم. ارتباط کلامی در این مسیر برای ما اهمیت دارد و تلاش می‌کنیم شما را با مشاوری که می‌تواند به زبان دلخواه و با آگاهی فرهنگی مرتبط با تجربه شما کنارتان باشد تطبیق دهیم." },
      { q: "مشاوره IFHP چه نوع حمایتی ارائه می‌دهد؟", a: "مشاوره IFHP در ChangeMoment می‌تواند در بهبود تروما، سوگ و فقدان، مدیریت اضطراب و افسردگی، سازگاری با کشور و فرهنگ جدید، استرس خانوادگی، مشکلات خواب و ساختن حس امنیت و تعلق در خانه جدیدتان کمک کند." },
      { q: "چند جلسه دریافت خواهم کرد؟", a: "تعداد جلسات تحت پوشش به مزایای فردی IFHP شما بستگی دارد. ما می‌توانیم در این فرایند به شما کمک کنیم." },
      { q: "چگونه شروع کنم؟", a: "می‌توانید یک وقت مشاوره رایگان با تیم ما رزرو کنید. ما بیمه شما را چک می‌کنیم، به سوالاتتان پاسخ می‌دهیم و شما را با مشاوری که با اهدافتان مطابقت دارد تطبیق می‌دهیم. مدارک IFHP خود را در اولین جلسه همراه داشته باشید." },
      { q: "اگر به مشاوره نیاز دارم اما پوشش IFHP ندارم چه کنم؟", a: "اگر در مورد پوشش خود مطمئن نیستید یا در حال حاضر مزایای IFHP ندارید، لطفاً باز هم با ما تماس بگیرید. می‌توانیم درباره گزینه‌های دیگر باهم صحبت کنیم و به شما کمک کنیم." },
    ],
  },
});
...
function OnlineCounsellingContent({ lang, page, serviceId }: { lang: "en" | "fr" | "fa"; page: ModernServicePage; serviceId: string }) {
  ...
  const usesRelatedServicesBackground = ["prenatal-and-pregnancy", "lgbtqia2s", "depression", "anxiety", "family-counselling"].includes(serviceId);
  ...
  return (
    <div className="service-modern-body">
      ...
      {copy.extraBodyTitle && copy.extraBody && copy.extraBodyPlacement === "beforeHow" ? (
        <Section>
          <Reveal>
            <div className={`mx-auto max-w-4xl rounded-[2.5rem] rounded-tr-none border p-7 shadow-[0_24px_70px_-52px_rgba(52,56,45,0.4)] md:p-10 ${isIfhpService ? "border-white/15 bg-[var(--brand-copper)] [&_h2]:!text-white" : usesRelatedServicesBackground ? "border-[var(--brand-muted-olive)]/22 bg-[var(--brand-sage-soft)]" : "border-[var(--brand-muted-olive)]/22 bg-[var(--brand-bone-soft)]"}`}>
              ...
              <p className={`mt-6 text-lg leading-8 md:leading-9 ${isIfhpService ? "text-white/90" : "text-[var(--brand-ink-muted)]"}`}>{formatLgbtqia2sText(copy.extraBody)}</p>
            </div>
          </Reveal>
        </Section>
      ) : null}
...
export function ServiceDetail() {
  ...
  const displayFaqs = service.id === "ifhp"
    ? faqSource
    : hasConsultationFaq
    ? faqSource
  ...
  const localizedFaqs = service.id === "ifhp"
    ? displayFaqs
    : displayFaqs.some((faq) => insuranceFaqMatch.test(faq.q))
    ? displayFaqs.map((faq) => {
  ...
  const hasMobileSubtitleGradient = ["anxiety", "family-counselling", "depression", "trauma", "anger-management", "ifhp"].includes(service.id);
